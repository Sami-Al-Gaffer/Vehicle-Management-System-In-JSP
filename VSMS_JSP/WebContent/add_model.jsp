    ...
    <div class="container body" Style="min-height:1000px;">
      <div class="main_container">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".add-model">Add New Model</button>
                        <% 
                	List<Manufacturer> list1 =ManufacturerInformation.getAllRecords();
        ...
        <div class="modal fade add-model" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <form action="carmodel.jsp" method="post" class="form-horizontal form-label-left" novalidate>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                   ...
                                   <c:forEach items="${list}" var="u">
                                            <option value="${u.getId()}" >${u.getManufacturerName()}</option>
                                   </c:forEach> 
                                   </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="model_description"  rows="10" class="form-control summernote"></textarea>
                                </div>
                  ...
                  <div class="x_content">
                   <%
					List<Model> list=ModelInformation.getAllRecords();
                     ...
                     <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <li><a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a></li>
                          <br>
                           <li> <a href="deletemodel.jsp?id=${m.getId()}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></li>
                            </ul>
