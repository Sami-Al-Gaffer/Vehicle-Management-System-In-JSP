...
<%@page import="UserCrud.ManufacturerInformation,Beans.Manufacturer,java.util.*"%>
            ...
            <div class="row">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>${m.getId()}</td>
                          <td>${m.getManufacturerName()}</td>
                          <td> </td>
                          <td>
               
                            <a href="deletemanufacturer.jsp?id=${m.getId()}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <form action="addmanufacturer.jsp" method="post" class="form-horizontal form-label-left" novalidate>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Manufacturer Name <span class="required">*</span>
                        </label>
                        <br>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="manufacturerName" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="file" class="form-control col-md-7 col-xs-12" name="manufacturer_logo" accept="image/*">
                        </div>
                      </div>
