...
<%@page import="UserCrud.UserInformation,Beans.User,java.util.*"%>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>All Employee <small>information</small></h3>
              </div>             
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <%
					List<User> list=UserInformation.getAllRecords();
					...
					<c:forEach items="${list}" var="u">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>${u.getUserType()}</td>
                          <td>
                            <a href="edit_all_employee.jsp?id=${u.getId()}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="deleteuser.jsp?id=${u.getId()}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
