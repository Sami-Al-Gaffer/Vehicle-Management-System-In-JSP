              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="edituser.jsp" method="post" class="form-horizontal form-label-left" novalidate>
                    <%@page import="UserCrud.UserInformation,Beans.User"%>  
  
					<%  
					String id=request.getParameter("id");  
					User u = UserInformation.getRecordById(Integer.parseInt(id));  
					%>  
					 
					<div class="item form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" name="id" value="<%=u.getId() %>" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<%= u.getFirstName() %>" id="firstName" name="firstName" required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<%=u.getLastName() %>" id="lastName" class="form-control col-md-7 col-xs-12"  name="lastName"  required="required">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" value="<%=u.getEmail() %>"id="email" name="email" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" value="<%=u.getMobile() %>" id="mobile" name="mobile" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<%=u.getPosition() %>" id="position" name="position" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <div class="item form-group">
                        <label for="password" class="control-label col-md-3">Password</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password" type="password" value="<%=u.getPassword() %>" name="password" data-validate-length="6,8" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
						...
						if(u.getGender().equals("Male")) 
						 ...
						 %>
                        <input type="radio"  required="required" name="gender" id="male" value="Male"   <%=checked%>   /> 
						...
						if(u.getGender().equals("Female")) 
						 ...
						 %>
                        <input type="radio"  required="required" name="gender" id="female" value="Female" <%=checked1 %>   />
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="birthDate" class="form-control col-md-7 col-xs-12" value="<%=u.getBirthDate() %>" name="birthDate"  required="required">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="address"  name="address"  class="form-control col-md-7 col-xs-12"> <%=u.getAddress() %></textarea>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
						...
						if(u.getUserType().equals("Admin")) 
						 ...
						 %>
                        <input type="radio"  required="required" name="userType" id="admin" value="Admin" <%=checked2 %>   /> 
                        Employee
                            <%
						String checked3 = "";
						if(u.getUserType().equals("Employee")) 
						 ...
						 %>
                        <input type="radio"  required="required" name="userType" id="employee" value="Employee" <%=checked3 %>   />
                        </div>
                      </div>
